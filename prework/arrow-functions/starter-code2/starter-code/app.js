...
// As a result of retaining the arrow functions of the `this` value of the enclosing functional scope.
// Moreover, the `this` context going to be in the browser of the global window object. 
